...
describe("File Mime Type", () =>
{
    ...
    describe("get mime type", () =>
    {
        ...
        it("should throw error if filename is null", () => expect(() => fileMimeType.get(null)).toThrowError(fileNullError));

        it("should throw error if filename does not have extension", () => expect(() => fileMimeType.get("filename")).toThrowError(fileWithoutExtensionError));
    ...
    describe("contains extension", () =>
    {
        ...
        it("should throw error if filename is null", () => expect(() => fileMimeType.containsExtension(null)).toThrowError(fileNullError));

        it("should throw error if filename does not have extension", () => expect(() => fileMimeType.containsExtension("filename")).toThrowError(fileWithoutExtensionError));
    });
