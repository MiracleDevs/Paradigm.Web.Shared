...
import { PersonMock } from "./extensions/person-mock";
...
describe("Local Storage", () => {
    ...
    describe("Objects", () => {
        it("should store and retrieve objects", () => {
            const person = new PersonMock();
            let person1: PersonMock | null = new PersonMock();
            let person2: PersonMock | null = new PersonMock();
            ...
            expect(person1).not.toBe(null);
            expect(person2).not.toBe(null);
    ...
    it("should get all content", () => {
        ...
        const allContent = LocalStorage.getAllContent();
